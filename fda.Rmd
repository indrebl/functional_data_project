...
```
```{r, echo = TRUE, fig.cap= "European country model analysis of PCA variability, without mean function."}
...
```
```{r, echo = TRUE, fig.cap= "Asian country model analysis of PCA variability, without mean function."}
